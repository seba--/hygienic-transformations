...
tuple[Edges,Edges,Edges] unhygienicLinks(NameGraph Gs, NameGraph Gt) {
  ...
  notPreserveDefinitionScope =  (u:Et[u] | d <- Vs & Vt, u <- Et, Et[u] == d, u in Es ? Es[u] != d : false);
  notSafeDefinitionReferences = (u:Et[u] | u <- Vt, u notin Es, u in Et, Et[u] != u);
  ...
  return <notPreserveSourceBinding, notPreserveDefinitionScope, notSafeDefinitionReferences>;
}
